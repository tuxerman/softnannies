...
#CREATE A TOPOLOGY WHERE EACH OF THE FOUR HOSTS GETS A FIXED BANDWIDTH ALLOCATION
class crazy_switches(Topo):
    ...
    def __init__(self, **opts):
        ...
        self.addLink(w1, s6, bw=100)
        self.addLink(w2, s6, bw=100)
        self.addLink(w3, s6, bw=100)
